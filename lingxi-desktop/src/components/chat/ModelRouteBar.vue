<template>
  <div class="model-route-bar">
    <el-icon class="model-route-icon"><Promotion /></el-icon>
    ...
    <el-dropdown v-if="modelRoute.canOverride" trigger="click" @command="handleCommand">
      ...
      <template #dropdown>
        <el-dropdown-menu>
          ...
          <el-dropdown-item command="qwen-max">Qwen Max</el-dropdown-item>
          <el-dropdown-item command="qwen-turbo">Qwen Turbo</el-dropdown-item>
        </el-dropdown-menu>
      </template>
    </el-dropdown>
  </div>
